...
<footer class="pt-5 pb-4 bg-dark">
    <div class="container">
        <div class="row">
            <div class="col-sm-4">
                <div class="card card-body">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab aliquam aliquid dolor enim est inventore praesentium quibusdam repudiandae sapiente tenetur.Lorem ipsum dolor sit amet, consectetur adipisicing elit. Ab aliquam aliquid dolor enim est inventore praesentium .</p>
                </div>
            </div>
            <div class="col-sm-4">
        ...
        <div class="row">
            <div class="col-12">
                <p class="text-white text-center mb-0">Copyright@2022,All right received by BASIS SEIP PWLF B-3</p>
            </div>
        </div>
    </div>
</footer>
